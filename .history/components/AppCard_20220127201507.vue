        ...
        <div class="container card-info">
          ...
          <div class="row card-number">
            ...
            <div v-else-if="card.fullNumber" class="col">
              <div class="full-number">{{ getN(0) }}</div>
              <div class="full-number">{{ getN(1) }}</div>
              <div class="full-number">{{ getN(2) }}</div>
              <div class="full-number">{{ getN(3) }}</div>
            </div>
          </div>
