    ...
    <div class="container">
      ...
      <div class="tabs">
        <div class="tab" active>
          <div class="tab-1" :class="{active : isActiveTab}">My debit cards</div>
          <div class="tab-2" :class="{active : !isActiveTab}">All company cards</div>
        </div>
        <div class="tab-content">
          <div class="tab-1-content" v-if="active">
            <app-card />
          </div>
